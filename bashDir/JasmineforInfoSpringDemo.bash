...
./doop -a 2-object-sensitive+heap --id SpringDemo -i /root/0610newtest/src/SpringDemo/ -l /root/0610newtest/libs/SpringDemo/ --open-programs jasmine --information-flow spring --platform java_8 --souffle-jobs 30 -t 3600
